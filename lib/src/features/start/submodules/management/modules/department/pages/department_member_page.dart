...
class DepartmentMemberPage<T> extends StatefulWidget {
  final MultiSelectParams params;
  const DepartmentMemberPage({
    required this.params,
    Key? key,
  }) : super(key: key);

  @override
  State<DepartmentMemberPage> createState() => _DepartmentMemberPageState();
}

class _DepartmentMemberPageState extends State<DepartmentMemberPage> {
