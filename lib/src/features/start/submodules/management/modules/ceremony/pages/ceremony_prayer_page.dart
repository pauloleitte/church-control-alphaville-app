...
class CeremonyPrayerPage<T> extends StatefulWidget {
  final MultiSelectParams params;
  const CeremonyPrayerPage({
    required this.params,
    Key? key,
  }) : super(key: key);

  @override
  State<CeremonyPrayerPage> createState() => _CeremonyPrayerPageState();
}

class _CeremonyPrayerPageState extends State<CeremonyPrayerPage> {
